...
{
    /*                  Поля и свойства                 */
    public Vector2 BeatMapRelativeSize = new(30f, 5f); // Проценты от ширины экрана (высота прямоугольника тоже зависит от ширины экрана)
    public Vector2 BeatMapRelativeSizeSelected = new(45f, 7.5f);
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        {
            SessionIgnisGame.CurrentSession =
                new GameSession(SessionIgnisGame, SessionSpriteBatch, GetSelectedBeatMap());
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        if (SelectedBeatMap != null)
        {
            ...
            for (int i = (int)(SelectedBeatMap == 0 ? 0 : SelectedBeatMap - 1); i < BeatMapsList.Count; i++)
            {
                ...
                if (beatMapPosHeight > SessionSpriteBatch.GraphicsDevice.Viewport.Height) break;
            }
        }
    }
    /*                  __Логика__                  */
    ...
    private void DrawBeatMap(BeatMap map, Vector2 position, Vector2 origin, bool isSelected)
    {
        ...
        IgnisRender.DrawText(SessionSpriteBatch,
            IgnisRender.CutStringToFitWidth(map.Name, relativeNameFontScale, boxWidth * percX * 0.97f,
                SessionSpriteBatch),
        ...
        IgnisRender.DrawText(SessionSpriteBatch,
            IgnisRender.CutStringToFitWidth(mapInfo, relativeNameFontScale * 0.8f, boxWidth * percX * 0.97f,
                SessionSpriteBatch),
