...
#nullable enable
            ...
            {
                {
                    0, new KeyValuePair<Stave.KeysEnum, HitSound>[]
                        { new(Stave.KeysEnum.InnerLeft, HitSound.HiHat), new(Stave.KeysEnum.InnerRight, HitSound.HiHat) }
                },

                {
                    10, new KeyValuePair<Stave.KeysEnum, HitSound>[]
                    {
                        new(Stave.KeysEnum.InnerRight, HitSound.HiHat),
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        // Отрисовка FPS
        {
            ...
            string fps = "FPS: " + _frameCounter.AverageFramesPerSecond.ToString("0.00");
